...
[![dilna demo](docs/media/demo-poster.jpg)](docs/media/demo.mp4)
<p><sub>(GitHub won't play video inline in a README — click the image to watch it on the file's own page.)</sub></p>
